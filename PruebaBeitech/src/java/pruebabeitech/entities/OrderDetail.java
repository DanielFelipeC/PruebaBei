...
@NamedQueries({
    ...
    , @NamedQuery(name = "OrderDetail.findByOrder", query = "SELECT o FROM OrderDetail o WHERE o.orderId.orderId = :idOrder")
})
public class OrderDetail implements Serializable {
    ...
    public String toString() {
        return "pruebabeitech.entities.OrderDetail[ orderDetailId=" + orderDetailId + " ]";
    }
